...
namespace dm.BanBonanza
{
    ...
    {
        public static async Task ReplyDMAsync(ICommandContext ctx, EmbedBuilder embed = null, Stream file = null, string fileName = null, string message = "", bool deleteUserMessage = true)
        {
        ...
        public static async Task SendAsync(ICommandContext ctx, ulong channelId, EmbedBuilder embed = null, Stream file = null, string fileName = null, string message = "")
        {
        ...
        public static async Task SendDMAsync(IUser user, EmbedBuilder embed = null, Stream file = null, string fileName = null, string message = "")
        {
